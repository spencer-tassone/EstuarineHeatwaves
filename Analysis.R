...
acesp_Filt2_30_do = lpfilt(acesp_DOdet_30,1/48,0.5)
acesp_Filt2_15_do = lpfilt(acesp_DOdet_15,1/96,0.5)
acesp_Filt2_30_ph = lpfilt(acesp_PHdet_30,1/48,0.5)
acesp_Filt2_15_ph = lpfilt(acesp_PHdet_15,1/96,0.5)
apaeb_Filt2_30_temp = lpfilt(apaeb_WTdet_30,1/48,0.5)
apaeb_Filt2_15_temp = lpfilt(apaeb_WTdet_15,1/96,0.5)
apaeb_Filt2_30_do = lpfilt(apaeb_DOdet_30,1/48,0.5)
apaeb_Filt2_15_do = lpfilt(apaeb_DOdet_15,1/96,0.5)
apaeb_Filt2_30_ph = lpfilt(apaeb_PHdet_30,1/48,0.5)
apaeb_Filt2_15_ph = lpfilt(apaeb_PHdet_15,1/96,0.5)
apaes_Filt2_30_temp = lpfilt(apaes_WTdet_30,1/48,0.5)
apaes_Filt2_15_temp = lpfilt(apaes_WTdet_15,1/96,0.5)
apaes_Filt2_30_do = lpfilt(apaes_DOdet_30,1/48,0.5)
apaes_Filt2_15_do = lpfilt(apaes_DOdet_15,1/96,0.5)
apaes_Filt2_30_ph = lpfilt(apaes_PHdet_30,1/48,0.5)
apaes_Filt2_15_ph = lpfilt(apaes_PHdet_15,1/96,0.5)
cbvtc_Filt2_15_temp = lpfilt(cbvtc_WTdet_15,1/96,0.5)
cbvtc_Filt2_15_do = lpfilt(cbvtc_DOdet_15,1/96,0.5)
cbvtc_Filt2_15_ph = lpfilt(cbvtc_PHdet_15,1/96,0.5)
delbl_Filt2_30_temp = lpfilt(delbl_WTdet_30,1/48,0.5)
delbl_Filt2_15_temp = lpfilt(delbl_WTdet_15,1/96,0.5)
delbl_Filt2_30_do = lpfilt(delbl_DOdet_30,1/48,0.5)
delbl_Filt2_15_do = lpfilt(delbl_DOdet_15,1/96,0.5)
delbl_Filt2_30_ph = lpfilt(delbl_PHdet_30,1/48,0.5)
delbl_Filt2_15_ph = lpfilt(delbl_PHdet_15,1/96,0.5)
delsl_Filt2_30_temp = lpfilt(delsl_WTdet_30,1/48,0.5)
delsl_Filt2_15_temp = lpfilt(delsl_WTdet_15,1/96,0.5)
delsl_Filt2_30_do = lpfilt(delsl_DOdet_30,1/48,0.5)
delsl_Filt2_15_do = lpfilt(delsl_DOdet_15,1/96,0.5)
delsl_Filt2_30_ph = lpfilt(delsl_PHdet_30,1/48,0.5)
delsl_Filt2_15_ph = lpfilt(delsl_PHdet_15,1/96,0.5)
elkap_Filt2_15_temp_first = lpfilt(elkap_WTdet_15_first,1/96,0.5)
elkap_Filt2_15_do_first = lpfilt(elkap_DOdet_15_first,1/96,0.5)
elkap_Filt2_15_ph_first = lpfilt(elkap_PHdet_15_first,1/96,0.5)
elkap_Filt2_30_temp = lpfilt(elkap_WTdet_30,1/48,0.5)
elkap_Filt2_30_do = lpfilt(elkap_DOdet_30,1/48,0.5)
elkap_Filt2_30_ph = lpfilt(elkap_PHdet_30,1/48,0.5)
elkap_Filt2_15_temp_second = lpfilt(elkap_WTdet_15_second,1/96,0.5)
elkap_Filt2_15_do_second = lpfilt(elkap_DOdet_15_second,1/96,0.5)
elkap_Filt2_15_ph_second = lpfilt(elkap_PHdet_15_second,1/96,0.5)
elksm_Filt2_15_temp_first = lpfilt(elksm_WTdet_15_first,1/96,0.5)
elksm_Filt2_15_do_first = lpfilt(elksm_DOdet_15_first,1/96,0.5)
elksm_Filt2_15_ph_first = lpfilt(elksm_PHdet_15_first,1/96,0.5)
elksm_Filt2_30_temp = lpfilt(elksm_WTdet_30,1/48,0.5)
elksm_Filt2_30_do = lpfilt(elksm_DOdet_30,1/48,0.5)
elksm_Filt2_30_ph = lpfilt(elksm_PHdet_30,1/48,0.5)
elksm_Filt2_15_temp_second = lpfilt(elksm_WTdet_15_second,1/96,0.5)
elksm_Filt2_15_do_second = lpfilt(elksm_DOdet_15_second,1/96,0.5)
elksm_Filt2_15_ph_second = lpfilt(elksm_PHdet_15_second,1/96,0.5)
grbgb_Filt2_30_temp = lpfilt(grbgb_WTdet_30,1/48,0.5)
grbgb_Filt2_15_temp = lpfilt(grbgb_WTdet_15,1/96,0.5)
grbgb_Filt2_30_do = lpfilt(grbgb_DOdet_30,1/48,0.5)
grbgb_Filt2_15_do = lpfilt(grbgb_DOdet_15,1/96,0.5)
grbgb_Filt2_30_ph = lpfilt(grbgb_PHdet_30,1/48,0.5)
grbgb_Filt2_15_ph = lpfilt(grbgb_PHdet_15,1/96,0.5)
hudsk_Filt2_30_temp = lpfilt(hudsk_WTdet_30,1/48,0.5)
hudsk_Filt2_15_temp = lpfilt(hudsk_WTdet_15,1/96,0.5)
hudsk_Filt2_30_do = lpfilt(hudsk_DOdet_30,1/48,0.5)
hudsk_Filt2_15_do = lpfilt(hudsk_DOdet_15,1/96,0.5)
hudsk_Filt2_30_ph = lpfilt(hudsk_PHdet_30,1/48,0.5)
hudsk_Filt2_15_ph = lpfilt(hudsk_PHdet_15,1/96,0.5)
hudts_Filt2_30_temp = lpfilt(hudts_WTdet_30,1/48,0.5)
hudts_Filt2_15_temp = lpfilt(hudts_WTdet_15,1/96,0.5)
hudts_Filt2_30_do = lpfilt(hudts_DOdet_30,1/48,0.5)
hudts_Filt2_15_do = lpfilt(hudts_DOdet_15,1/96,0.5)
hudts_Filt2_30_ph = lpfilt(hudts_PHdet_30,1/48,0.5)
hudts_Filt2_15_ph = lpfilt(hudts_PHdet_15,1/96,0.5)
job09_Filt2_30_temp = lpfilt(job09_WTdet_30,1/48,0.5)
job09_Filt2_15_temp = lpfilt(job09_WTdet_15,1/96,0.5)
job09_Filt2_30_do = lpfilt(job09_DOdet_30,1/48,0.5)
job09_Filt2_15_do = lpfilt(job09_DOdet_15,1/96,0.5)
job09_Filt2_30_ph = lpfilt(job09_PHdet_30,1/48,0.5)
job09_Filt2_15_ph = lpfilt(job09_PHdet_15,1/96,0.5)
narpc_Filt2_30_temp = lpfilt(narpc_WTdet_30,1/48,0.5)
narpc_Filt2_15_temp = lpfilt(narpc_WTdet_15,1/96,0.5)
narpc_Filt2_30_do = lpfilt(narpc_DOdet_30,1/48,0.5)
narpc_Filt2_15_do = lpfilt(narpc_DOdet_15,1/96,0.5)
narpc_Filt2_30_ph = lpfilt(narpc_PHdet_30,1/48,0.5)
narpc_Filt2_15_ph = lpfilt(narpc_PHdet_15,1/96,0.5)
nocec_Filt2_30_temp = lpfilt(nocec_WTdet_30,1/48,0.5)
nocec_Filt2_15_temp = lpfilt(nocec_WTdet_15,1/96,0.5)
nocec_Filt2_30_do = lpfilt(nocec_DOdet_30,1/48,0.5)
nocec_Filt2_15_do = lpfilt(nocec_DOdet_15,1/96,0.5)
nocec_Filt2_30_ph = lpfilt(nocec_PHdet_30,1/48,0.5)
nocec_Filt2_15_ph = lpfilt(nocec_PHdet_15,1/96,0.5)
nocrc_Filt2_30_temp = lpfilt(nocrc_WTdet_30,1/48,0.5)
nocrc_Filt2_15_temp = lpfilt(nocrc_WTdet_15,1/96,0.5)
nocrc_Filt2_30_do = lpfilt(nocrc_DOdet_30,1/48,0.5)
nocrc_Filt2_15_do = lpfilt(nocrc_DOdet_15,1/96,0.5)
nocrc_Filt2_30_ph = lpfilt(nocrc_PHdet_30,1/48,0.5)
nocrc_Filt2_15_ph = lpfilt(nocrc_PHdet_15,1/96,0.5)
pdbby_Filt2_30_temp = lpfilt(pdbby_WTdet_30,1/48,0.5)
pdbby_Filt2_15_temp = lpfilt(pdbby_WTdet_15,1/96,0.5)
pdbby_Filt2_30_do = lpfilt(pdbby_DOdet_30,1/48,0.5)
pdbby_Filt2_15_do = lpfilt(pdbby_DOdet_15,1/96,0.5)
pdbby_Filt2_30_ph = lpfilt(pdbby_PHdet_30,1/48,0.5)
pdbby_Filt2_15_ph = lpfilt(pdbby_PHdet_15,1/96,0.5)
welin_Filt2_30_temp = lpfilt(welin_WTdet_30,1/48,0.5)
welin_Filt2_15_temp = lpfilt(welin_WTdet_15,1/96,0.5)
welin_Filt2_30_do = lpfilt(welin_DOdet_30,1/48,0.5)
welin_Filt2_15_do = lpfilt(welin_DOdet_15,1/96,0.5)
welin_Filt2_30_ph = lpfilt(welin_PHdet_30,1/48,0.5)
welin_Filt2_15_ph = lpfilt(welin_PHdet_15,1/96,0.5)
...
all_daily_data$pH_gap <- rep(ph_miss$values*ph_miss$lengths,ph_miss$lengths)

GapTable <- all_daily_data %>%
  group_by(Station) %>%
  summarise(Max_Temp_Gap = (max(temp_gap)/8766)*100,
            Max_DO_Gap = (max(do_gap)/8766)*100,
            Max_pH_Gap = (max(pH_gap)/8766)*100)

round(max(GapTable$Max_Temp_Gap),2)
round(max(GapTable$Max_DO_Gap),2)
round(max(GapTable$Max_pH_Gap),2)
...
SlopeTable %>%
  group_by(Variable) %>%
  summarise(MeanSlope = round(mean(Slope),2),
            SDslope = round(sd(Slope),2))
...
SI_Fig1_temp <- all_daily_data %>%
  ...
  labs(y=expression(paste("Daily Avg. Temp. (°C) - Tide & Diurnal Removed")),
       x=expression(paste("Daily Avg. Temp. (°C)"))) +
  facet_wrap("Station") +
  theme_bw() +
  ...
  stat_regline_equation(
    ...
    label.x = -3, label.y = 30, size = 4.75, color = "black") +
  stat_cor(aes(label = paste(..rr.label.., sep = "~~~")),
           label.x = 16, label.y = 5, size = 4.75, color = "black")

SI_Fig_do <- all_daily_data %>%
  ...
  stat_regline_equation(
    aes(label = paste(..eq.label.., sep = "~~~")),
    label.x = -4, label.y = 16, size = 4.75, color = "black") +
  stat_cor(aes(label = paste(..rr.label.., sep = "~~~")),
           label.x = 8, label.y = 3, size = 4.75, color = "black")

SI_Fig1_ph <- all_daily_data %>%
  ...
  stat_regline_equation(
    aes(label = paste(..eq.label.., sep = "~~~")),
    label.x = 5.75, label.y = 8.35, size = 4.75, color = "black") +
  stat_cor(aes(label = paste(..rr.label.., sep = "~~~")),
           label.x = 7.1, label.y = 6.5, size = 4.75, color = "black")

# width = 1000 height = 1600
ggarrange(SI_Fig1_temp,SI_Fig_do,SI_Fig1_ph,ncol = 1,nrow = 3)
...
MHW$Year <- year(MHW$date_peak)
MHW$Month <- month(MHW$date_peak)
...
LDO$Year <- year(LDO$date_peak)
LDO$Month <- month(LDO$date_peak)
...
LPH$Year <- year(LPH$date_peak)
LPH$Month <- month(LPH$date_peak)
...
EHW_SalTable <- MHW %>%
  group_by(Sal.class) %>%
  summarise(MeanDuration = round(mean(duration)),
            SEduration = round(sd(duration)/sqrt(n()),2),
            MeanCuInt =  round(mean(intensity_mean_relThresh),2),
            SEcuInt = round(sd(intensity_mean_relThresh)/sqrt(n()),2),
            MeanOnset = round(mean(rate_onset, na.rm = T),2),
            SEonset = round(sd(rate_onset, na.rm = T)/sqrt(n()),2),
            MeanDecline = round(mean(rate_decline, na.rm = T),2),
            SEdecline = round(sd(rate_decline, na.rm = T)/sqrt(n()),2),
            Frequency = round(length(duration)/n_distinct(Station)),
            Nevents = n(),
            Nstations = n_distinct(Station))
EHW_SalTable$Order <- c(3,2,4,5,1)
EHW_SalTable <- EHW_SalTable[,c(13,1:12)]
EHW_SalTable <- EHW_SalTable %>%
  arrange(-desc(Order))
View(EHW_SalTable)
...
do_region <- LDO %>%
  group_by(Year, Region) %>%
  summarise(Avg.Duration = mean(duration, na.rm = T),
            Avg.CuInt = mean(abs(intensity_cumulative_relThresh), na.rm = T),
            Avg.Onset = mean(abs(rate_onset), na.rm = T),
            Avg.Decline = mean(abs(rate_decline), na.rm = T),
            SumEvents = length(duration))
do_salinity <- LDO %>%
  group_by(Year, Sal.class) %>%
  summarise(Avg.Duration = mean(duration, na.rm = T),
...
### Table 2: 10% False Discovery Rate (see link for details: http://www.biostathandbook.com/multiplecomparisons.html)
...
AHW$Year <- year(AHW$date_peak)
AHW$Month <- month(AHW$date_peak)
...
AHW_SeasonTable <- AHW %>%
  ...
  summarise(MeanDuration = round(mean(duration)),
            ...
            MeanDecline = round(mean(rate_decline, na.rm = T),2),
            SEdecline = round(sd(rate_decline, na.rm = T)/sqrt(n()),2),
            Frequency = round(length(duration)/n_distinct(StationCode)),
            Nevents = n(),
            Nreserves = n_distinct(StationCode))
AHW_SeasonTable$Order <- c(4,2,3,1)
AHW_SeasonTable <- AHW_SeasonTable[,c(13,1:12)]
AHW_SeasonTable <- AHW_SeasonTable %>%
  arrange(-desc(Order))
View(AHW_SeasonTable)
...
AHW_RegionTable <- AHW %>%
  ...
  summarise(MeanDuration = round(mean(duration)),
            ...
            Nevents = n(),
            Nreserves = n_distinct(StationCode))
AHW_RegionTable$Order <- c(4,2,1,3,5)
AHW_RegionTable <- AHW_RegionTable[,c(13,1:12)]
AHW_RegionTable <- AHW_RegionTable %>%
  arrange(-desc(Order))
View(AHW_RegionTable)
...
#SI_Fig2A: Atmospheric temperature trends
...
SI_Fig2A <- rbind(mean_Atemp_table,mean_SD_table)
SI_Fig2A$upper <- round(SI_Fig2A$upper,2)
SI_Fig2A$lower <- round(SI_Fig2A$lower,2)
...
#SI_Fig2B: Estuarine water temperature trends
...
SI_Fig2B <- rbind(mean_Wtemp_table,mean_SD_table)
...
SI_Fig2a <- SI_Fig2A %>%
  ...
  labs(y=expression(paste("Slope (°C  ", yr^-1,")")),
       x = "NERRS Reserves & Regions") +
  scale_y_continuous(breaks = seq(-0.12,0.14, by = 0.02)) +
  ...
  theme(plot.margin = margin(5,5,55,5,"pt"),
        ...
        legend.background = element_blank()) +
  coord_cartesian(clip = "off", ylim = c(-0.12, 0.14)) +
  annotate("text", x = c(2.5,5.5,8,10,11.5), y = -0.165, label = c("Northeast", "Mid. Atl.", "Southeast","GoM","West"), size = 5) +
...
# SI Figure 4: Linear Regression & boxplot for Low DO characteristics
...
# SI Figure 5: Linear Regression & boxplot for Low pH characteristics
...
hudts <- all_daily_data[all_daily_data$Station == 'hudts',]
...
names(ahw_clim)[names(ahw_clim) == "ATemp"] <- "Temperature"

ahw_plot <- ggplot(data = ahw_clim, aes(x = date)) +
  geom_flame(aes(y = Temperature, y2 = Threshold, fill = "all"), show.legend = F) +
  geom_flame(data = ahw_clim, aes(y = Temperature, y2 = Threshold, fill = "top"),  show.legend = F) +
  ...
  labs(y = expression(paste("Air Temperature ( ", degree, "C)")), x = NULL) +
  theme_bw() +
  theme(panel.grid = element_blank(),
        text = element_text(size = 16),
        axis.text.x = element_blank(),
...
mhw_plot <- ggplot(data = mhw_clim, aes(x = date)) +
  ...
  labs(Fill = "Event") +
  guides(colour = guide_legend(override.aes = list(fill = NA))) +
  labs(y = expression(paste("Water Temperature ( ", degree, "C)")), x = NULL) +
  theme_bw() +
  theme(panel.grid = element_blank(),
        text = element_text(size = 16),
        axis.text.x = element_blank(),
...
do_plot <- ggplot(data = lowdo_clim, aes(x = date)) +
  ...
  guides(colour = guide_legend(override.aes = list(fill = NA))) +
  labs(y = expression(Dissolved~Oxygen~(mg~L^{-1})), x = NULL) +
  theme_bw() +
  theme(panel.grid = element_blank(),
        text = element_text(size = 16),
...
ph_plot <- ggplot(data = lowph_clim, aes(x = date)) +
  ...
  scale_x_date(date_labels = "%b %Y") +
  guides(colour = guide_legend(override.aes = list(fill = NA))) +
  labs(y = expression(paste("pH")), x = NULL) +
  theme_bw() +
  theme(panel.grid = element_blank(),
        text = element_text(size = 16),
        axis.text.x = element_text(size = 16, color = "black", angle = 30, vjust = 1, hjust = 1),
